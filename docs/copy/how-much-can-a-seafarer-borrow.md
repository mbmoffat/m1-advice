# How much can a seafarer borrow for a mortgage? — copy record
...
**H1:** How much can a seafarer borrow for a mortgage?
...
Two things: the income a lender is willing to assess, and how that income fares against the lender's affordability test. The test weighs your committed outgoings, dependants and any existing credit against the assessed income. No lender offers a guaranteed figure in advance, but the assessed income is the lever that moves your number most, and for seafarers it is also the part most often read wrongly.

## How does foreign currency change the figure?

If you are paid in US dollars or euros, a lender converts the income to sterling and applies a reduction to allow for the rate moving against you, then works from that lower figure. The size of that reduction varies between lenders, so the lender you choose changes your borrowing more than the interest rate does. Links to the foreign currency income page (`/seafarer-mortgage-foreign-currency-income`).

## Mid CTA

Want to know the figure a lender would actually assess? Tell us how you are paid. → Start the 60-Second Check → `/check?scenario=seafarer&src=/how-much-can-a-seafarer-borrow`

## How does the Seafarers Earnings Deduction affect borrowing?

The Seafarers Earnings Deduction (SED) lowers your UK tax, not your earnings. An automated check can read the low tax figure as a low income and shrink what it will lend. A lender that understands seafarers works from your gross contractual pay instead, so the deduction does not have to cost you borrowing. Links to the Seafarers Earnings Deduction page (`/seafarers-earnings-deduction-mortgage`).
...
Stop guessing at the number. Let an adviser work it out from your real income. → Check Your Options → `/check?scenario=seafarer&src=/how-much-can-a-seafarer-borrow`
...
**Heading:** Find out what you could borrow
**Line:** Tell us how you are paid and a Mortgage One adviser will review your answers.
**Button:** Check Your Eligibility → `/check?scenario=seafarer&src=/how-much-can-a-seafarer-borrow`
